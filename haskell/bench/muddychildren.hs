...
findNumberTrans = findNumberWith (start, SMCDEL.Symbolic.S5.evalViaBdd)
  where
...
findNumberTransK = findNumberWith (start, SMCDEL.Symbolic.K.evalViaBdd)
  where
...
findNumberTriangle n m = findNumberTriangleLoop 0 start
  where
